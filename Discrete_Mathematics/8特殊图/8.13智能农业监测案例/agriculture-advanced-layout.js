(function () {
  ...
  function start() {
    ...
    window.setTimeout(applyLayout, 160);
    window.setTimeout(applyLayout, 520);
    window.addEventListener("resize", applyLayout);
    const app = document.querySelector(".app-container");
    if (app) new MutationObserver(scheduleApply).observe(app, { attributes: true, attributeFilter: ["style", "class"] });
  }
